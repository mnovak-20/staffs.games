...
const charImages = import.meta.glob('../../Assets/images/gallery_images/character/*.{jpg,jpeg,png,webp}', { eager: true });

// Map into usable data with credits from filenames
const charPanels = Object.entries(charImages).map(([path, mod]) => {
...
export default function CharGallerySection() {
    return <GalleryCarousel panels={charPanels} fullScreen={true} />;
}
