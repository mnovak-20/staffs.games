...
const weaponImages = import.meta.glob('../../Assets/images/gallery_images/weapon/*.{jpg,jpeg,png,webp}', { eager: true });

// Map into usable data with credits from filenames
const weaponPanels = Object.entries(weaponImages).map(([path, mod]) => {
...
export default function WeaponGallerySection() {
    return <GalleryCarousel panels={weaponPanels} fullScreen={true} />;
}