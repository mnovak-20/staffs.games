...
const envImages = import.meta.glob('../../Assets/images/gallery_images/environment/*.{jpg,jpeg,png,webp}', { eager: true });

// Map into usable data with credits from filenames
const envPanels = Object.entries(envImages).map(([path, mod]) => {
...
export default function EnvGallerySection() {
    return <GalleryCarousel panels={envPanels} fullScreen={true} />;
}
