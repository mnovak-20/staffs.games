...
const vehicleImages = import.meta.glob('../../Assets/images/gallery_images/vehicle/*.{jpg,jpeg,png,webp}', { eager: true });

// Map into usable data with credits from filenames
const vehiclePanels = Object.entries(vehicleImages).map(([path, mod]) => {
...
export default function VehicleGallerySection() {
    return <GalleryCarousel panels={vehiclePanels} fullScreen={true} />;
}
