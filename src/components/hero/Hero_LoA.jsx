...
const heroImages = import.meta.glob('../../Assets/images/loa/*.{jpg,jpeg,png,webp}', { eager: true });
...
export default function HeroLoA() {
    ...
    return (
        <section className="relative h-[30vh] sm:h-[50vh] lg:h-[60vh] w-full overflow-hidden text-white">
            ...
            {/* Top-left content */}
            <div className="relative whitespace-nowrap text-UofS-Yellow-100 z-10 flex flex-col items-start px-10 sm:px-14 md:px-18 lg:px-20 pt-16 sm:pt-24 lg:pt-26 max-w-[800px] scale-110">
